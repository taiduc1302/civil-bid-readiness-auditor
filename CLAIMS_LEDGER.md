...
| The app supports presentation-only findings filters and stable temporary results navigation without mutating deterministic findings or dispositions. | `app/review_filters.py`, `tests/test_review_filters.py`, `tests/test_server_filters.py`. |
