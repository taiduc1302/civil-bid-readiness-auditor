...
class RuntimeCompositionUnitTests(unittest.TestCase):
    ...
    def test_explicit_page_kind_not_display_title_controls_review_augmentation(self):
        # A historical display title alone is no longer a capability switch.
        ...
        # A completely different display title still receives all review-only
        # augmentation when the stable internal page identity is set.
