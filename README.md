...
See `product/operational_reference_ui_contract.md` for the Crew Code / Production Rate browser-evidence boundary and `product/review_delta_contract.md` for Review Delta comparison/export semantics.
