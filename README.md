...
10. The repository also contains a tested evidence-only Crew Code / Production Rate comparison module that compares only values explicitly present on both sides. It is **not yet exposed through the normal browser reference workflow and does not run automatically**; the governed UI/package integration remains future work.
